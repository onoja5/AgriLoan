...
import { CropType, FieldLogActivity, QualityGrade } from './types'; // Added imports from types

export const APP_NAME = "AgriLoan Connect NG";

export const IconFarm: React.FC<{className?: string}> = ({className}) => (
...
export const IconBuyer: React.FC<{className?: string}> = ({className}) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
  </svg>
);

export const IconAdmin: React.FC<{className?: string}> = ({className}) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const IconClock: React.FC<{className?: string}> = ({className}) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" > 
    {/* // Removed className assignment from here as it's passed from props */}
...
export const IconSparkles: React.FC<{className?: string}> = ({className}) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L1.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.25 7.5l.813 2.846a4.5 4.5 0 012.098 2.098L24 12l-2.846.813a4.5 4.5 0 01-2.098 2.098L18.25 18.75l-.813-2.846a4.5 4.5 0 01-2.098-2.098L12.5 12l2.846-.813a4.5 4.5 0 012.098-2.098L18.25 7.5z" />
  </svg>
);


export const CROP_TYPES_ARRAY = Object.values(CropType);
export const FIELD_LOG_ACTIVITIES_ARRAY = Object.values(FieldLogActivity);
export const QUALITY_GRADES_ARRAY = Object.values(QualityGrade);
